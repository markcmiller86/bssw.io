...
**Hero Image:**
 ...
 - <img src='https://github.com/betterscientificsoftware/images/raw/master/Blog_1120_PSIP_HDF5_BlackHole.png' />[Simulation of black hole merger with data managed by the HDF5 I/O and data modeling library.]
...
[Use of PSIP helps teams to improve software practices, with productivity boosts that quickly recapture the initial investment as well as any costs due to disruption of existing processes.]<img src='https://github.com/betterscientificsoftware/images/raw/master/Blog_1120_Diagram_Progress.png' class='page' />
...
[PSIP progress tracking card representing the incremental steps used to address process improvement goals in documentation. See hyperlinks above for PTCs for GitHub migration and coding standards.]<img src='https://github.com/betterscientificsoftware/images/raw/master/Blog_1120_PSIP_Large.png' class='page lightbox' />
